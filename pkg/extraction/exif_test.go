...
func TestCaptureDate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:         "sample1.JPG",
			setTimestamp: true,
			timeStamp:    parseTimeString(t, "2015-12-24 13:59:17 +0100 CET").UTC(),
		},
		{
			name:         "sample2.mp4",
			setTimestamp: true,
			timeStamp:    parseTimeString(t, "2016-04-02 09:23:56 +0200 CEST").UTC(),
		},
		{
			name:         "sample3.txt",
			setTimestamp: true,
			timeStamp:    parseTimeString(t, "2018-06-15 15:24:26.263360885 +0200 CEST").UTC(),
		},
		{
